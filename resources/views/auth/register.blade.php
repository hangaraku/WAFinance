...
<head>
    ...
    <title>{{ __('common.register') }} - {{ __('common.app_name') }}</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('login') }}" class="bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 transition-colors">
                        {{ __('common.login') }}
                    </a>
                </div>
            </div>
