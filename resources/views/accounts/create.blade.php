    ...
    <div class="bg-white shadow-sm border-b border-gray-200">
        <div class="px-4 py-4">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-xl font-semibold text-gray-900">Create New Account</h1>
                    <p class="text-sm text-gray-600">Add a new financial account</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <form action="{{ route('accounts.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-6 gap-2">
                        ...
                        <label class="flex items-center justify-center">
                            <input type="radio" name="color" value="{{ $color }}" 
                                   class="sr-only peer" {{ $color === 'blue' ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-4 gap-3">
                        ...
                        <label class="flex flex-col items-center p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 transition-colors">
                            <input type="radio" name="icon" value="{{ $iconKey }}" 
                                   class="sr-only peer" {{ $iconKey === 'banknotes' ? 'checked' : '' }}>
                            <div class="w-8 h-8 text-gray-600 peer-checked:text-orange-600 mb-2">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (selectedIcon) {
        updateIconSelection(selectedIcon.value);
    }
});
</script>
@endsection
